            ...
            <form className="mt-8" onSubmit={handleSubmit(onSubmit)}>
              <div className="space-y-5">
                <div>
                  ...
                  <div className="mt-2">
                    <input  {...register('username', { required: "username Required...!", })} placeholder="UserName" type="text" className="flex h-10 w-full rounded-md border border-gray-300 bg-transparent px-3 py-2 text-sm placeholder:text-gray-400 focus:outline-none focus:ring-1 focus:ring-gray-400 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50" />
                    {errors.username && <p className='text-sm text-red-600'>{errors.username.message as ReactNode}</p>}
                ...
                {/* <div>
                  ...
                  <div className="mt-2">
                    <input placeholder="ReEnter Password" type="password" className="flex h-10 w-full rounded-md border border-gray-300 bg-transparent px-3 py-2 text-sm placeholder:text-gray-400 focus:outline-none focus:ring-1 focus:ring-gray-400 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50" />
                  </div>
                </div> */}
                <div>
